# Phase 4 Task 21: Parse Financial Accounting Chunk au
...
## Input
- File: books/export/financial_accounting/financial_accounting_chunk_au.md
...
## Output
- File: processed/financial_accounting/financial_accounting_chunk_au_parsed.json
