# Phase 4 Task 06: Parse Financial Accounting Chunk af
...
## Input
- File: books/export/financial_accounting/financial_accounting_chunk_af.md
...
## Output
- File: processed/financial_accounting/financial_accounting_chunk_af_parsed.json
