# Phase 3 Task 22: Convert Financial Accounting Chunk av
...
## Input
- File: books/rawtxt/financial_accounting/financial_accounting_chunk_av
...
## Output
- File: books/export/financial_accounting/financial_accounting_chunk_av.md
