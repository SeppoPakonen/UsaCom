# Phase 3 Task 17: Convert Financial Accounting Chunk aq
...
## Input
- File: books/rawtxt/financial_accounting/financial_accounting_chunk_aq
...
## Output
- File: books/export/financial_accounting/financial_accounting_chunk_aq.md
