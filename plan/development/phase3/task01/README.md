# Phase 3 Task 1: Convert First Raw Text File to Simplified Markdown

## Objective
Convert the first file in ./books/rawtxt/ to simplified markdown format in ./books/export/ for later concatenation.
